...
public class SystemController {
    ...
    public SystemController(DynamicRuleNacosDataSource dynamicRuleNacosDataSource) {
    ...
    public Result<List<SystemRuleEntity>> apiQueryMachineRules(String app, String ip,
        ...
        try {
            List<SystemRuleEntity> rules = dynamicRuleNacosDataSource.getRules(app, SystemRule.class,SystemRuleEntity::fromSystemRule);
    ...
    private void publishRules(String app) throws Exception {
        ...
        dynamicRuleNacosDataSource.publish(app, rules, SystemRule.class,SystemRuleEntity::toRule);
    }
}
