...
@Component
public class AuthorityRuleNacosSourceProvider extends NacosSourceProvider<AuthorityRule> {


    protected AuthorityRuleNacosSourceProvider(NacosConfigClientProvider nacosConfigClientProvider, Converter<String, List<AuthorityRule>> converter, NacosProperties nacosProperties) {
