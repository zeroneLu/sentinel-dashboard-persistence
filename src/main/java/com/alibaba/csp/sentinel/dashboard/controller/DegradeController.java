...
public class DegradeController {
    ...
    public DegradeController(DynamicRuleNacosDataSource dynamicRuleNacosDataSource) {
    ...
    public Result<List<DegradeRuleEntity>> apiQueryMachineRules(String app, String ip, Integer port) {
        ...
        try {
            List<DegradeRuleEntity> rules = dynamicRuleNacosDataSource.getRules(app, DegradeRule.class, DegradeRuleEntity::fromDegradeRule);
    ...
    private void publishRules(String app) throws Exception {
        ...
        dynamicRuleNacosDataSource.publish(app, rules,DegradeRule.class,DegradeRuleEntity::toRule);
    }
}
