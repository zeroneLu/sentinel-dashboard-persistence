...
public class GatewayFlowRuleControllerV2 {
    ...
    public GatewayFlowRuleControllerV2(InMemGatewayFlowRuleStore repository, DynamicRuleNacosDataSource dynamicRuleNacosDataSource) {
    ...
    public Result<List<GatewayFlowRuleEntity>> queryFlowRules(String app) {
        ...
        try {
            List<GatewayFlowRuleEntity>  rules = dynamicRuleNacosDataSource.getRules(app, GatewayFlowRule.class, GatewayFlowRuleEntity::fromGatewayFlowRule);
    ...
    private void publishRules(String app, String ip, Integer port) throws Exception {
        ...
        dynamicRuleNacosDataSource.publish(app, rules,GatewayFlowRule.class,GatewayFlowRuleEntity::toGatewayFlowRule);
    }
}
