...
public class AuthorityRuleController {
    ...
    public AuthorityRuleController(DynamicRuleNacosDataSource dynamicRuleNacosDataSource) {
    ...
    public Result<List<AuthorityRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            List<AuthorityRuleEntity> rules = dynamicRuleNacosDataSource.getRules(app, AuthorityRule.class, AuthorityRuleEntity::fromAuthorityRule);
    ...
    private void publishRules(String app) throws Exception {
        ...
        dynamicRuleNacosDataSource.publish(app, rules,AuthorityRule.class,AbstractRuleEntity::toRule);
    }
}
