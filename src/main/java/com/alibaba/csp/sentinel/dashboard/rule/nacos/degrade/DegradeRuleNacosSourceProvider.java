...
@Component
public class DegradeRuleNacosSourceProvider extends NacosSourceProvider<DegradeRule>{


    protected DegradeRuleNacosSourceProvider(NacosConfigClientProvider nacosConfigClientProvider, Converter<String, List<DegradeRule>> converter, NacosProperties nacosProperties) {
