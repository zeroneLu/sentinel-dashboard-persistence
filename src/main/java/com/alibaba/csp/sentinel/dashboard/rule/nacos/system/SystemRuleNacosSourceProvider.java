...
@Component
public class SystemRuleNacosSourceProvider extends NacosSourceProvider<SystemRule> {


    protected SystemRuleNacosSourceProvider(NacosConfigClientProvider nacosConfigClientProvider, Converter<String, List<SystemRule>> converter, NacosProperties nacosProperties) {
