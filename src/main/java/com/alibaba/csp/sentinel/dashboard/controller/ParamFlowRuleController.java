...
public class ParamFlowRuleController {
    ...
    public ParamFlowRuleController(DynamicRuleNacosDataSource dynamicRuleNacosDataSource) {
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            List<ParamFlowRuleEntity> rules = dynamicRuleNacosDataSource.getRules(app, ParamFlowRule.class, ParamFlowRuleEntity::fromParamFlowRule);
    ...
    private void publishRules(String app) throws Exception {
        ...
        dynamicRuleNacosDataSource.publish(app, rules,ParamFlowRule.class,AbstractRuleEntity::toRule);
    }
