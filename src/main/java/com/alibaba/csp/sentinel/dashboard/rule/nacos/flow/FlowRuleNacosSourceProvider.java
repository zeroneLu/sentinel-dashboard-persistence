...
@Component
public class FlowRuleNacosSourceProvider extends NacosSourceProvider<FlowRule> {


    protected FlowRuleNacosSourceProvider(NacosConfigClientProvider nacosConfigClientProvider, Converter<String, List<FlowRule>> converter, NacosProperties nacosProperties) {
