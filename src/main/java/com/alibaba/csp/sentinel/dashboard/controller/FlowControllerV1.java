...
public class FlowControllerV1 {
    ...
    public FlowControllerV1(DynamicRuleNacosDataSource dynamicRuleNacosDataSource) {
    ...
    public Result<FlowRuleEntity> apiUpdateFlowRule(Long id, String app,
        ...
        if (StringUtil.isNotBlank(limitApp)) {
            rule.setLimitApp(limitApp.trim());
        }
        if (StringUtil.isNotBlank(resource)) {
            rule.setResource(resource.trim());
        }
        if (grade != null) {
            if (grade != 0 && grade != 1) {
        ...
        if (strategy != null) {
            ...
            if (strategy != 0) {
                ...
                rule.setRefResource(refResource.trim());
            }
        }
