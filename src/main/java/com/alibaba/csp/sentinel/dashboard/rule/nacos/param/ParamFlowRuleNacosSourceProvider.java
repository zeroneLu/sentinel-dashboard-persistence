...
@Component
public class ParamFlowRuleNacosSourceProvider extends NacosSourceProvider<ParamFlowRule> {


    protected ParamFlowRuleNacosSourceProvider(NacosConfigClientProvider nacosConfigClientProvider, Converter<String, List<ParamFlowRule>> converter, NacosProperties nacosProperties) {
